...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(empty($nome) || empty($email)){
        ...
        header("Location: editar.php?cod=" . $codigo);
        exit;
    }
    
    // Cria o objeto Prospect com o código para atualização
    ...
    try {
        ...
        if($resultado === TRUE){
            $_SESSION['sucesso'] = "Prospect atualizado com sucesso!";
            header("Location: listar.php");
        }
        
    } catch(\Exception $e) {
        $_SESSION['erro'] = "Erro ao atualizar prospect: " . $e->getMessage();
        header("Location: editar.php?cod=" . $codigo);
    }
